...
/* Number of the configured PORT ports */
...
/* JTAG symbolic names*/
#define PORT_JTAG_0                          (Port_PinType)16
#define PORT_JTAG_1                          (Port_PinType)17
#define PORT_JTAG_2                          (Port_PinType)18
#define PORT_JTAG_3                          (Port_PinType)19

/* Port configured symbolic name */
/* Port A symbolic pins */
...
/* Port C symbolic pins (exclude the JTAG pins Pc[0:3]) */
...
/* Port pin modes*/
#define PORT_DIO_MODE                        (Port_PinModeType)0
#define PORT_ANALOG_MODE                     (Port_PinModeType)1
#define PORT_SSI_MODE                        (Port_PinModeType)2
#define PORT_I2C_MODE                        (Port_PinModeType)3
#define PORT_PWM_MODE                        (Port_PinModeType)4
#define PORT_CAN_MODE                        (Port_PinModeType)8
